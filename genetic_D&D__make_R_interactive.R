show_menu <- function() {
  while (TRUE) {
    ...
    if (choice == "0") {
      ...
      cat(" \n")    
      cat(" \n")   
      cat(" The effective population size is the minimum size of a population to keep the observed variation of alleles. Ne Estimator V2 can be calculated in R. All results will be saved and a extra csv file will be created saving Ne, the parametric and non parametric confidence intervals of each population. There was a threshold used of 0.05. Meanwhile the input files for Speed Ne are created. To use the Speed Ne application Matlab needs to be installed first.\n")
      cat(" \n")
      cat(" \n")
      cat(" \n")    
      cat(" \n")
      ...
      cat(" \n")    
      cat(" \n")   
      cat(" This script creates a table saved as .csv-file. Content of this table is the AWT Ne calculation with rc² and corresponding confidence intervals of all sites that could be calculated. Ne with a threshold for rare alleles and parametric and non parametric confidence intervals are saved for that value.\n")
      cat(" \n")
      cat(" \n")
      cat(" \n")    
      cat(" \n")
