...
correlation_results_with_Ne <- data.frame(
  ...
  p_value = c(Ne_diversity_correlation_p_value, Ne_Amova_correlation_p_value, Ne_Overlaps_correlation_p_value, diversity_Overlaps_correlation_p_value_cut, diversity_Amova_correlation_p_value_cut, Amova_Overlaps_correlation_p_value_cut),  
  correlation_coefficient = c(Ne_diversity_correlation_coefficient, Ne_Amova_correlation_coefficient, Ne_Overlaps_correlation_coefficient, diversity_Overlaps_correlation_coefficient_cut, diversity_Amova_correlation_coefficient_cut, Amova_Overlaps_correlation_coefficient_cut)
)
...
# Save as .csv -files
write.csv(correlation_results_with_Ne, file = paste("Results", describe_results_variable, "/Compare_all_methods/correlation_results_without_NeS.csv", sep = ""), row.names = FALSE)
...
correlation_matrix_with_Ne <- data.frame(
  AMOVA = c(1, correlation_results_with_Ne[5,3], correlation_results_with_Ne[6,3], correlation_results_with_Ne[2,3]),
  rare = c(correlation_results_with_Ne[5,3], 1, correlation_results_with_Ne[4,3], correlation_results_with_Ne[1,3]),
  Overlaps = c(correlation_results_with_Ne[6,3], correlation_results_with_Ne[4,3], 1, correlation_results_with_Ne[3,3]), 
  Ne = c(correlation_results_with_Ne[2,3], correlation_results_with_Ne[1,3], correlation_results_with_Ne[3,3], 1)
)
rownames(correlation_matrix_with_Ne) <- c("AMOVA", "rare", "Overlaps", "Ne")
correlation_matrix_with_Ne <- as.matrix(correlation_matrix_with_Ne)
# Create a p-value matrix
p_matrix_with_Ne <- data.frame(
  AMOVA = c(1, correlation_results_with_Ne[5,2], correlation_results_with_Ne[6,2], correlation_results_with_Ne[2,2]),
  rare = c(correlation_results_with_Ne[5,2], 1, correlation_results_with_Ne[4,2], correlation_results_with_Ne[1,2]),
  Overlaps = c(correlation_results_with_Ne[6,2], correlation_results_with_Ne[4,2], 1, correlation_results_with_Ne[3,2]),
  Ne = c(correlation_results_with_Ne[2,2], correlation_results_with_Ne[1,2], correlation_results_with_Ne[3,2], 1)
)
rownames(p_matrix_with_Ne ) <- c("AMOVA", "rare", "Overlaps", "Ne")
...
dev.copy(png, file.path(paste("Results", describe_results_variable, "/Compare_all_methods", sep = ""), "correlations_without_NeS.png"))
dev.off()
