...
correlation_results <- data.frame(
  tested_methods = c("Ne_diversity", "Ne_Amova", "Ne_Overlaps",
                     ...
                     "Ne_AvTD", "AvTD_AMOVA", "diversity_AvTD",
                     "AvTD_Overlaps"),
  p_value = c(Ne_diversity_correlation_p_value, Ne_Amova_correlation_p_value, Ne_Overlaps_correlation_p_value, 
              ...
              Ne_AvTD_correlation_p_value , AvTD_AMOVA_correlation_p_value, 
              diversity_AvTD_correlation_p_value, AvTD_overlap_correlation_p_value),  
  correlation_coefficient = c(Ne_diversity_correlation_coefficient, Ne_Amova_correlation_coefficient, Ne_Overlaps_correlation_coefficient, 
                              ...
                              Ne_AvTD_correlation_coefficient, AvTD_AMOVA_correlation_coefficient, 
                              diversity_AvTD_correlation_coefficient, AvTD_overlap_correlation_coefficient)
)

# Create matrices for correlation results with Ne
# Create a correlation matrix
correlation_matrix <- data.frame(
  AMOVA = c(1, correlation_results[5,3], correlation_results[6,3], correlation_results[2,3], correlation_results[8,3]),
  lambda = c(correlation_results[5,3], 1, correlation_results[4,3], correlation_results[1,3],  correlation_results[9,3]),
  Overlaps = c(correlation_results[6,3], correlation_results[4,3], 1, correlation_results[3,3], correlation_results[10,3]), 
  Ne = c(correlation_results[2,3], correlation_results[1,3], correlation_results[3,3], 1,  correlation_results[7,3]), 
  AvTD = c(correlation_results[8,3], correlation_results[9,3], correlation_results[10,3],  correlation_results[7,3], 1)
)
colnames(correlation_matrix) <- c("AMOVA", ":λ[cor]", "Allelic Overlap", "NᴇEsᴛɪᴍᴀᴛᴏʀ",  ":Δ[j]^'+'")
rownames(correlation_matrix) <- c("AMOVA", ":λ[cor]", "Allelic Overlap", "NᴇEsᴛɪᴍᴀᴛᴏʀ",  ":Δ[j]^'+'")
correlation_matrix <- as.matrix(correlation_matrix)

# Create a p-value matrix
p_matrix <- data.frame(
  AMOVA = c(1, correlation_results[5,2], correlation_results[6,2], correlation_results[2,2], correlation_results[8,2]),
  lambda = c(correlation_results[5,2], 1, correlation_results[4,2], correlation_results[1,2], correlation_results[9,2]),
  Overlaps = c(correlation_results[6,2], correlation_results[4,2], 1, correlation_results[3,2],  correlation_results[10,2]), 
  Ne = c(correlation_results[2,2], correlation_results[1,2], correlation_results[3,2], 1, correlation_results[7,2]), 
  AvTD = c(correlation_results[8,2], correlation_results[9,2], correlation_results[10,2],  correlation_results[7,2], 1)
)
colnames(p_matrix) <- c("AMOVA", ":λ[cor]", "Allelic Overlap", "NᴇEsᴛɪᴍᴀᴛᴏʀ",  ":Δ[j]^'+'")
rownames(p_matrix) <- c("AMOVA", ":λ[cor]", "Allelic Overlap", "NᴇEsᴛɪᴍᴀᴛᴏʀ",  ":Δ[j]^'+'")
...
# specifically load the environment for COL2()
COL2 <- get("COL2", envir = asNamespace("corrplot"))
